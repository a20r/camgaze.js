...
\textbf{Algorithm 1} shows a high-level overview of $\Name$. The algorithm goes
first through a calibration phase. Once the system is calibrated, it is able to
project the gaze position of the user. 
...
shows the deviation of the $\Function{err}_{\alpha}$ for the two connected
components. Since the has a smaller overall error and is returned as the pupil.
